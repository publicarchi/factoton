  ...
  <xsl:template match="/">
    <html>
      <head>
        ...
        <link href="../remarks/themes/remark-dark.css" rel="stylesheet" media="all" type="text/css"/>
      </head>
      <body>
        <textarea id="source">
        ...
        <script src="../remarks/js/remark-0.6.5.min.js" type="text/javascript"/>
...
<xsl:template match="div[@xml:lang='en']"/>
  ...
  <xsl:template match="div[@rend = 'title'] | div[@type = 'title']">
    <xsl:call-template name="newline"/>
    <xsl:text>---</xsl:text>
    <xsl:call-template name="newline"/>
    <xsl:text>template: inverse</xsl:text>
  ...
  <xsl:template match="div[@rend = 'slide'] | div[@rend = 'sommaire'] | div[@type = 'slide'] | div[@type = 'sommaire']">
    <xsl:call-template name="newline"/>
    <xsl:text>---</xsl:text>
    <xsl:call-template name="newline"/>
    <xsl:if test="@xml:id">
  ...
  <xsl:template match="div[@rend = 'slide']/div[2] | div[@rend = 'title']/div[2] | div[@type = 'slide']/div[2] | div[@type = 'title']/div[2]">
    <xsl:call-template name="newline"/>
    <xsl:text>???</xsl:text>
    <xsl:call-template name="newline"/>
    <xsl:apply-templates/>
