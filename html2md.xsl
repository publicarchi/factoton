...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/1999/XSL/Transform"
  ...
  <!-- html2md
    @author bauhaus
    @from https://github.com/bauhouse/xslt-markdown/blob/master/markdown.xsl
    @see https://www.getsymphony.com/download/xslt-utilities/view/20573/
    @see http://fletcherpenney.net/2006/03/markdown_and_xml
    @see https://daisy-trac.cvsdude.com/obi/browser/trunk/docs/template.xslt
  -->
